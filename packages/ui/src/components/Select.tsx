...
// A plain native <select>, styled to match the rest of the kit. Swapping in
// a Radix-based combobox later (for search-as-you-type on long lists like
// the price list) is a drop-in replacement — same props shape.
